...
class UploadManager {
    ...
    func upload(file: FileUpload, subscription: Subscription, progress: UploadProgressBlock, completion: @escaping UploadCompletionBlock,completionFileId : @escaping successCallback) {
        ...
        if store == "AmazonS3" {
            ...
            uploadToUFSFile(store: store, file: file, subscription: subscription, progress: progress, completion: completion, completionFileId: completionFileId)
        }
    }

    // swiftlint:disable function_body_length
    func uploadToUFSFile(store: String, file: FileUpload, subscription: Subscription, progress: UploadProgressBlock, completion: @escaping UploadCompletionBlock,completionFileId : @escaping successCallback) {
        ...
        SocketManager.send(request) { [unowned self] (response) in
            ...
            completionFileId(fileIdentifier)
